...
public class DocumentDashboardLocators {
	...
	public static By ADD_BUTTON = By.xpath("//div[contains(@class,'add-button')]");
	public static By ADD_TEXT = By.xpath("//div[contains(@class,'add-text')]");
	...
	public static By CREATEDOCUMENT_POPUP_TAB =By.xpath("//span[contains(@text(),'Add Details')]");
	
	// Title
	public static By CREATEDOCUMENT_TITLE= By.xpath("//label[normalize-space()='Title']");
	public static By CREATEDOCUMENT_FORMINPUT =By.xpath("//input[@placeholder='Add any title here...']");
	...
	public static By R = By.xpath("//span[normalize-space()='R']");
	public static By G = By.xpath("//span[normalize-space()='G']");
	public static By B = By.xpath("//span[normalize-space()='B']");
	public static By A = By.xpath("//span[normalize-space()='A']");
	...
	public static By COLOR_CIRCLE_SELECTED = By.xpath("//div[@class='color-circle-selected']");
	public static By COLOR_CIRCLE = By.xpath("//div[@class='color-circle']");
	...
	public static By DOCUMENT_DRAGnDROP = By.xpath("//div[.//span[text()='Document']]");
	public static By DOCUMENT_UPLOAD_AREA = By.xpath("//span[text()='Document']/following::div[contains(@class,'file-upload-area')][1]");
	...
	public static By THUMBNAIL_DRAGnDROP = By.xpath("//div[.//span[text()='Thumbnail']]");
	public static By THUMBNAIL_UPLOAD_AREA = By.xpath("//span[text()='Thumbnail']/following::div[contains(@class,'file-upload-area')][1]");
	...
	public static By CREATEDOCUMENT_CALENDER_POPUP = By.xpath("//mat-datepicker-content[@class='mat-datepicker-content.ng-tns-c78-16.ng-trigger.ng-trigger-transformPanel.mat-primary.ng-star-inserted']");
	...
	public static By PUBLISH = By.xpath("//button[normalize-space()='publish']");
	public static By CREATEDOCUMENT_CANCEL = By.xpath("//button[@class='btn.btn-secondary.bold-text']");
